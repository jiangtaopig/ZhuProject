...
//        yearWheelItemView.getWheelView().setItemVerticalSpace(90);
    ...
    public void setTitleAppearance(int appearance){
        tvTitle.setTextAppearance(appearance);
    }
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    public void setOkAppearance(int appearance){
        tvOK.setTextAppearance(appearance);
    }
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    public void setCancelAppearance(int appearance){
        tvCancel.setTextAppearance(appearance);
    }

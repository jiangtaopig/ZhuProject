...
public class CustomCancelView extends View {
    ...
    public void startAnimate(final boolean isOpen, final SimpleCallback<Void> callback) {
        ...
        Log.e("zzzzz", "startAnimate  isOpen = "+isOpen);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.e("cccc", "onDraw isInSide = "+isInSide+", mRadius = "+mRadius);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.e("CustomCancelView", "mRadius = "+mRadius+", width = "+width+", height = "+height);

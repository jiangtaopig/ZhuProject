...
public class TabLayout extends RelativeLayout{
    ...
    private void initAttrs(Context context, AttributeSet attrs){
        ...
        if (attrs != null){
            ...
            mLeftTextAppearance = typedArray.getResourceId(R.styleable.TabLayout_left_title_appearance, R.style.font_14sp_333333);
            mRightTxt = typedArray.getString(R.styleable.TabLayout_right_title);
            mRightTextAppearance = typedArray.getResourceId(R.styleable.TabLayout_right_title_appearance, R.style.font_14sp_999999);
        }else {
            mLeftTxt = "left tab";
            mLeftTextAppearance = R.style.font_14sp_333333;
            mRightTxt = "right tab";
            mRightTextAppearance = R.style.font_14sp_999999;
        }
    }
    ...
    private void init(){
        ...
        mRightTab.setOnClickListener(v -> {
            if (mTabSelectListener != null){
    ...
    private void initTabView() {
        mTabLayout.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                ...
                mLeftTabTextWidth = getTextWidth(mLeftTab);
                mRightTabWidth = mRightTab.getWidth();
                mRightTabTextWidth = getTextWidth(mRightTab);

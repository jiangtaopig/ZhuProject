...
import com.example.za_zhujiangtao.zhupro.h5_acc.utils.DataHelper;
import com.example.za_zhujiangtao.zhupro.h5_acc.utils.WebViewUtil;
 ...
 * h5 加速
 */
public class WebAccumulateActivity extends AppCompatActivity {

    private static final String TAG = "WebAccumulateActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_h5_acc);
        // 获取从外面带过来的标记
...
//            }
    ...
    public static void go2YuGangShuoActivity(Context context, boolean isLoadLocal) {
        Intent intent = new Intent(context, WebAccumulateActivity.class);

package com.example.za_zhujiangtao.zhupro.swipe_back;
...
import com.example.za_zhujiangtao.zhupro.swipe_back.app.SwipeBackListenerActivityAdapter;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     */
    private static final float DEFAULT_SCROLL_THRESHOLD = 0.5f; //修改移到屏幕一半时松开也会滑动关闭
    ...
    public void setOnScrollListener(ViewDragHelper.OnScrollListener listener){
        mDragHelper.setOnScrollListener(listener);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        Log.e("onInterceptTouchEvent ", "mEnable = "+mEnable);
        if (!mEnable) {
            return false;
        }
        try {
